            ...
            <div className='min-h-screen flex flex-col justify-between overflow-hidden relative'>
                <main>
                    ...
                    <section className='sm:w-5/6 max-w-2xl sm:mx-auto mt-24 mb-16 p-4 sm:p-10 flex flex-col bg-gradient-to-tr from-gray-200 to-transparent rounded-lg z-20'>
                        <Image src={product.media.source} alt={product.name} width='450' height='450' objectFit='cover' placeholder='blur' blurDataURL={product.media.source} />
                        <div className='mt-6'>
                        ...
                        <button type='button' aria-label='Add to Cart' onClick={() => addToCart(product.id, 1)} className='mt-4 self-end border border-green-400 px-4 py-1.5 rounded-2xl hover:bg-green-600 hover:border-white group focus:outline-none z-30'>
                        ...
                        <div className='mt-10 xl:mt-14 flex justify-between z-30'>

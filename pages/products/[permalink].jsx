    ...
    return (
        <>
            ...
            <main className='min-h-screen overflow-hidden flex flex-col justify-between relative'>
                ...
                <Banner />
                <section className='w-5/6 max-w-2xl mx-auto mt-24 mb-16 p-10 flex flex-col bg-gradient-to-tr from-gray-200 to-transparent rounded-lg z-20'>
                    ...
                    <div className='mt-10 xl:mt-14 text-2xl flex justify-between'>
                        <Link href='/'><a>To <span className='font-medium text-purple-400 hover:text-purple-300'>Motherboards</span></a></Link>
                        <Link href='/cart'><a>To <span className='font-medium text-blue-500 hover:text-blue-400'>Cart</span></a></Link>
                    </div>
                </section>
                <Footer />
            </main>
